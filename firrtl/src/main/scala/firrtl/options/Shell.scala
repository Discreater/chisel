...
class BareShell(val applicationName: String) {
  ...
  protected val parser: OptionParser[AnnotationSeq] with DuplicateHandling with ExceptOnError[AnnotationSeq] = new OptionParser[AnnotationSeq](applicationName) with DuplicateHandling with ExceptOnError[AnnotationSeq]
