...
@deprecated(deprecatedPublicAPIMsg, "Chisel 3.6")
object PrimOp {
  val AddOp: PrimOp = PrimOp("add")
  val SubOp: PrimOp = PrimOp("sub")
  val TailOp: PrimOp = PrimOp("tail")
  val HeadOp: PrimOp = PrimOp("head")
  val TimesOp: PrimOp = PrimOp("mul")
  val DivideOp: PrimOp = PrimOp("div")
  val RemOp: PrimOp = PrimOp("rem")
  val ShiftLeftOp: PrimOp = PrimOp("shl")
  val ShiftRightOp: PrimOp = PrimOp("shr")
  val DynamicShiftLeftOp: PrimOp = PrimOp("dshl")
  val DynamicShiftRightOp: PrimOp = PrimOp("dshr")
  val BitAndOp: PrimOp = PrimOp("and")
  val BitOrOp: PrimOp = PrimOp("or")
  val BitXorOp: PrimOp = PrimOp("xor")
  val BitNotOp: PrimOp = PrimOp("not")
  val ConcatOp: PrimOp = PrimOp("cat")
  val BitsExtractOp: PrimOp = PrimOp("bits")
  val LessOp: PrimOp = PrimOp("lt")
  val LessEqOp: PrimOp = PrimOp("leq")
  val GreaterOp: PrimOp = PrimOp("gt")
  val GreaterEqOp: PrimOp = PrimOp("geq")
  val EqualOp: PrimOp = PrimOp("eq")
  val PadOp: PrimOp = PrimOp("pad")
  val NotEqualOp: PrimOp = PrimOp("neq")
  val NegOp: PrimOp = PrimOp("neg")
  val MultiplexOp: PrimOp = PrimOp("mux")
  val AndReduceOp: PrimOp = PrimOp("andr")
  val OrReduceOp: PrimOp = PrimOp("orr")
  val XorReduceOp: PrimOp = PrimOp("xorr")
  val ConvertOp: PrimOp = PrimOp("cvt")
  val AsUIntOp: PrimOp = PrimOp("asUInt")
  val AsSIntOp: PrimOp = PrimOp("asSInt")
  val AsFixedPointOp: PrimOp = PrimOp("asFixedPoint")
  val AsIntervalOp: PrimOp = PrimOp("asInterval")
  val WrapOp: PrimOp = PrimOp("wrap")
  val SqueezeOp: PrimOp = PrimOp("squz")
  val ClipOp: PrimOp = PrimOp("clip")
  val SetBinaryPoint: PrimOp = PrimOp("setp")
  val IncreasePrecision: PrimOp = PrimOp("incp")
  val DecreasePrecision: PrimOp = PrimOp("decp")
  val AsClockOp: PrimOp = PrimOp("asClock")
  val AsAsyncResetOp: PrimOp = PrimOp("asAsyncReset")
}
